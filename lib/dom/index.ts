...
export const getElementsByTagName: GetElementsByTagName = <T extends HTMLElement>(
  tagName: string,
) => {
...
export const getFirstElementByTagName: GetFirstElementByTagName = <T extends HTMLElement>(
  tagName: string,
) => {
  const elements = document.getElementsByTagName(tagName);
