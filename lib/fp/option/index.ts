...
export type FlatMap = <A, B>( option: Option<A>,
  f: (a: A) => Option<B>,
) => Option<B>;
...
export const isNone = <A>(a: Option<A>): a is None =>
  a._tag === 'None';
...
export const map: Map = (a, f) =>
  isNone(a) ? none : some(f(a.value));

export const flatMap: FlatMap = (a, f) =>
